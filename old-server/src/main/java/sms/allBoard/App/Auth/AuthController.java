...
import sms.allBoard.App.Auth.DTO.VerificationRequestDTO;
import sms.allBoard.App.Auth.DTO.VerificationResponseDTO;
import sms.allBoard.App.Auth.Exception.SignUpException;
import sms.allBoard.App.Auth.Exception.TokenRefreshException;
import sms.allBoard.App.Auth.Exception.VerificationException;
...
import sms.allBoard.Common.Service.Verification.Model.Identifier.EmailIdentifier;
import sms.allBoard.Common.Service.Verification.Model.Identifier.Identifier;
import sms.allBoard.Common.Service.Verification.Model.Info.EmailVerificationInfo;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Object>> accessToken(
        ...
        String oldRefreshToken = stringRedisUtil.get(oldRefreshKey);
    ...
    public ResponseEntity<ApiResponse<Object>> refreshToken(
        ...
        stringRedisUtil.delete(oldRefreshKey);

        // 재발급한 리프레시 토큰 redis에 저장
        stringRedisUtil.set(newRefreshKey, newRefreshToken);
